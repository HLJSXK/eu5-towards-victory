...
OUT_FILE = (
    ...
    / "common"
    / "static_modifiers"
    / "tv_wonder_ceremony_cost_local_modifiers.txt"
)
SCRIPT_REL = "scripts_engineering_department/main_menu/common/static_modifiers/gen_tv_wonder_ceremony_cost_local_modifiers.py"
