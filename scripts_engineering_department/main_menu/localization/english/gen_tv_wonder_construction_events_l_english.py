...
OUT_FILE = REPO_ROOT / "src_engineering_department" / "main_menu" / "localization" / "english" / "tv_wonder_construction_events_l_english.yml"
SCRIPT_REL = "scripts_engineering_department/main_menu/localization/english/gen_tv_wonder_construction_events_l_english.py"
