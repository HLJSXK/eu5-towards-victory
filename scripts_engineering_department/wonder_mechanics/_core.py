...
MANUAL_TV_GAME_CONCEPTS_FILE = REPO_ROOT / "src_engineering_department" / "main_menu" / "common" / "game_concepts" / "tv_game_concepts.txt"
FONT_ICONS_FILE = REPO_ROOT / "reference_game_files" / "game" / "main_menu" / "gui" / "shared" / "font_icons.gui"
ALL_WONDER_MIN_ID = 1
ALL_WONDER_MAX_ID = 56
UNIQUE_WONDER_MIN_ID = 101
UNIQUE_WONDER_MAX_ID = 236
