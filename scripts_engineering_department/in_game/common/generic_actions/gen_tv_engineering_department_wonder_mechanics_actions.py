...
OUT_FILE = REPO_ROOT / "src_engineering_department" / "in_game" / "common" / "generic_actions" / "tv_engineering_department_wonder_mechanics_actions.txt"
SCRIPT_REL = "scripts_engineering_department/in_game/common/generic_actions/gen_tv_engineering_department_wonder_mechanics_actions.py"
T = "\t"
HAGIA_WONDER_ID = 102
HAGIA_ACTIONS = [
