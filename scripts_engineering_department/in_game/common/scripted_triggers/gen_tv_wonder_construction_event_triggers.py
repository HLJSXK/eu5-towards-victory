...
OUT_FILE = REPO_ROOT / "src_engineering_department" / "in_game" / "common" / "scripted_triggers" / "tv_wonder_construction_event_triggers.txt"
SCRIPT_REL = "scripts_engineering_department/in_game/common/scripted_triggers/gen_tv_wonder_construction_event_triggers.py"
