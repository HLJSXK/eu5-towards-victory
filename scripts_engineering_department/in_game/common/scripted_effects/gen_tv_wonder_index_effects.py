...
OUT_FILE = REPO_ROOT / "src_engineering_department" / "in_game" / "common" / "scripted_effects" / "tv_wonder_index_effects.txt"
SCRIPT_REL = "scripts_engineering_department/in_game/common/scripted_effects/gen_tv_wonder_index_effects.py"
T = "\t"
