...
OUT_FILE = REPO_ROOT / "src_engineering_department" / "in_game" / "events" / "tv_wonder_construction_events.txt"
SCRIPT_REL = "scripts_engineering_department/in_game/events/gen_tv_wonder_construction_events.py"
