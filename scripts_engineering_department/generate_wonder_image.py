...
CONFIG_PATH = Path(__file__).resolve().parent / "generate_wonder_image_config.json"
LOCAL_CONFIG_PATH = Path(__file__).resolve().parent / "generate_wonder_image.local.json"
