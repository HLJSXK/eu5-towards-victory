...
All five interface validators must bind those artifacts back to external source-file validation
evidence rather than trusting the report alone. These prototypes do not cover listener output
yet. They must keep
