...
from wonder_expansion_lib import EXPANSION_FILE, WONDERS_FILE, ceremony_modifier_for_building, load_yaml
...
DATA_REL = "data/wonders.yaml + data/wonder_expansion.yaml"
