...
from wonder_expansion_lib import WONDERS_FILE, ceremony_modifier_for_building, load_all_wonder_mechanics, load_yaml
...
DATA_REL = "data/wonders.yaml + data/wonder_expansion.yaml + data/unique_wonders.yaml"
...
def main() -> None:
    ...
    for idx, wonder in enumerate(wonders):
        ...
        for building in wonder["final_buildings"].values():
            ceremony_modifier = ceremony_modifier_for_building(wonder, expansion, building)
