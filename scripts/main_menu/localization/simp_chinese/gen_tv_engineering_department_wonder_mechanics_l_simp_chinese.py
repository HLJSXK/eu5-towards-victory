...
def generate() -> str:
    ...
    lines.append(loc_line("PERFORM_tv_wonder_confirm_ceremony_scaled_gold_ACTION_SETUP", "当我们确认金币奇观落成仪式时。"))
    lines.append(loc_line("PERFORM_tv_wonder_confirm_ceremony_scaled_gold_ACTION_LOG", "我们确认了金币奇观落成仪式。"))
    lines.append(loc_line("PERFORM_tv_wonder_confirm_ceremony_scaled_gold_ACTION_MAP", ""))
    lines.append(loc_line("PERFORM_tv_wonder_confirm_ceremony_prestige_ACTION_SETUP", "当我们确认威望奇观落成仪式时。"))
    lines.append(loc_line("PERFORM_tv_wonder_confirm_ceremony_prestige_ACTION_LOG", "我们确认了威望奇观落成仪式。"))
